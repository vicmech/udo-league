    ...
    return(
        <div class='flex flex-col justify-center items-center h-1/4'>
            ...
            <div class='flex flex-row justify-center items-center h-4/5 py-8 space-x-20'>
                <img class='h-full w-3/5' src="/static/images/KabyLN.png" alt="logo-kaby-wear" />
                <img class='h-full w-3/5' src="/static/images/Pipos-NombreCompleto.png" alt="logo-pipos-house" />
            </div>
        </div>
    )
}