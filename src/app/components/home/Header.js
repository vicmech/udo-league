    ...
    return(
        <header class='w-full h-1/6 flex flex-row'>
            ...
            <div class='w-full h-full'>
                <div class='h-1/2 bg-main-blue align-middle text-start pl-24 text-white text-3xl leading-10 py-3'><span>UDO LEAGUE</span></div>
                <nav class='h-1/2 flex flex-row justify-center items-center bg-white'>
                    <ul class='h-1/2 w-full px-20 flex flex-row justify-center items-center justify-around text-2xl text-grayText'>
                        ...
                        <li class='decoration-4 hover:underline decoration-main-blue'><a href="#table">Tabla</a></li>
                        <li ><a class='decoration-4 hover:underline decoration-main-blue' href="#teams">Equipos</a></li>
                    </ul>
                </nav>
            </div>
        </header>
